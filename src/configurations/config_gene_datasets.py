...
params_sets = {
    '''
    "graphs": set(['kde_mask', 'num_genes', 'algorithm', 'by_group', 'thr_p', 'id_part', 'num_parts']),
    "graph": set(['kde_mask', 'num_genes', 'algorithm', 'by_group', 'thr_p', 'id_sample']),
    "degrees": set(['kde_mask', 'num_genes', 'algorithm', 'by_group']),
    "parenclitic": set(['kde_mask', 'num_genes', 'algorithm', 'by_group', 'thr_p']),
    "degrees_sample": set(['kde_mask', 'num_genes', 'algorithm', 'by_group', 'thr_p', 'id_sample']),
    "parenclitic_sample": set(['kde_mask', 'num_genes', 'algorithm', 'by_group', 'thr_p', 'id_sample']),
    "degrees_boxplots": set(['kde_mask', 'num_genes', 'algorithm', 'by_group']),
    "parenclitic_boxplots": set(['kde_mask', 'num_genes', 'algorithm', 'by_group', 'thr_p']),
    "diff_graph": set(['kde_mask', 'num_genes', 'algorithm', 'by_group']),
    "pair_genes": set(['kde_mask', 'num_genes', 'algorithm', 'by_group', 'thr_p', 'id_pair']),
    "kdes": set(['kde_mask', 'num_genes', 'algorithm', 'by_group', 'thr_p', 'id_pair']),
    "parenclitic_boxplot": set(['kde_mask', 'num_genes', 'algorithm', 'by_group', 'thr_p', 'id_parenclitic']),
    "down_phenotypes": set(['num_genes']),
    '''
}

config = configuration(params, info, files, data_name = 'gene_datasets', project_name = 'Gerontology', config_name = 'gene_datasets', params_sets = params_sets)
