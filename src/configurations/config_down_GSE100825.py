...
files = {
    ...
    "patients_info": "GSE100825_samples.txt",
...
config = configuration(params, info, files, data_name = 'GSE100825', project_name = 'Gerontology', config_name = 'down_syndrome', params_sets = params_sets)
