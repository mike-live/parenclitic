...
files = {
    ...
    "patients_info": "GSE131752_samples.txt",
    "cells": "GSE131752_MAge_Horvath_NEW_AgeCalculator.output.tsv",
...
config = configuration(params, info, files, data_name = 'GSE131752', project_name = 'Gerontology', config_name = 'down_syndrome', params_sets = params_sets)
